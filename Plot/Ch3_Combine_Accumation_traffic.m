...
subplot(221)
rtcplot( f1,'k',f2,'b',f3,'r--',f4,'g--',[0 110 0 5000], ...
    'LineWidth',2,...
    'MarkerSize',12,... 
     'MarkerEdgeColor','k',...
      'MarkerFaceColor','r') ;
...
t = title('\boldmath $ Preemption $ \boldmath $ mode $ \boldmath $ Service $ \boldmath $ Curve $ \boldmath $ of $ \boldmath $ AVB_x $')
...
subplot(222)
rtcplot( f1,'m',f2,'c',f3,'r--',f4,'g--',[0 110 0 500], ...
    'LineWidth',2,...
    'MarkerSize',12,... 
     'MarkerEdgeColor','k',...
      'MarkerFaceColor','r') ;
...
subplot(224)
rtcplot( f1,'b',f2,'r',f3,'k--',f4,'g--',[0 110 0 500], ...
    'LineWidth',2,...
    'MarkerSize',12,... 
     'MarkerEdgeColor','k',...
      'MarkerFaceColor','r') ;
