...
save_time = rtcminus(f1,f2) ;

rtcplot( f1,'b',f2,'r',f3,'k--',f4,'g--',save_time,'c:',[0 110 0 500], ...
    'LineWidth',2,...
    'MarkerSize',12,... 
     'MarkerEdgeColor','k',...
      'MarkerFaceColor','r') ;
...
%%
h=legend('\boldmath $ Service $ \boldmath $Curve$ \boldmath $of$ \boldmath $AVB_A$ ','\boldmath $ Improved$ \boldmath $ Service $ \boldmath $Curve$ \boldmath $of$ \boldmath $AVB_B$',...
    '\boldmath $ Arrival $ \boldmath $Curve$ \boldmath $of$ \boldmath $AVB_A$ ',...
    '\boldmath $ Arrival $ \boldmath $Curve$ \boldmath $of$ \boldmath $AVB_B$','   \boldmath $ Save $ \boldmath $time $'); % Legend name inside the box

h.FontSize = 8;   

t = title('\boldmath $ Non $ \boldmath $ Preemption $ \boldmath $ mode $ \boldmath $ Service $ \boldmath $ Curve $ \boldmath $ of $ \boldmath $ AVB_x(CBS+TAS) $')
...
%figure('Position',[0 0 800 600], 'Color','w')
f1 = rtccurve([[0 0 0];[10 0 20];[20 200 0]],30);
f2 = rtccurve([[0 0 0];[15 0 10];[30 150 0]],40);
f3 = rtccurve([[0 100 2]]);
f4 = rtccurve([[0 80 1.5]]);
subplot(222)
save_time = rtcminus(f1,f2) ;
rtcplot( f1,'m',f2,'c',f3,'r--',f4,'g--',save_time,'k:',[0 110 0 500], ...
    'LineWidth',2,...
    'MarkerSize',12,... 
     'MarkerEdgeColor','k',...
      'MarkerFaceColor','r') ;
...
t = title('\boldmath $ Preemption $ \boldmath $ mode $ \boldmath $ Service $ \boldmath $ Curve $ \boldmath $ of $ \boldmath $ AVB_x $ \boldmath $ (CBS+TAS) $')
set(h, 'Interpreter', 'latex','FontName','Time New Roman');
set(t, 'Interpreter', 'latex','FontName','Time New Roman');
...
subplot(223)
save_time = rtcminus(f1,f2) ;
rtcplot( f1,'m',f2,'c',f3,'r--',f4,'b--',save_time,'r:',[0 110 0 500], ...
    'LineWidth',2,...
    'MarkerSize',12,... 
     'MarkerEdgeColor','k',...
      'MarkerFaceColor','r') ;
...
h.FontSize = 8;   
t = title('\boldmath $ Non $ \boldmath $ Preemption $ \boldmath $ mode $ \boldmath $ Service $ \boldmath $ Curve $ \boldmath $ of $ \boldmath $ AVB_x $\boldmath $ (CBS) $')
set(h, 'Interpreter', 'latex','FontName','Time New Roman');
set(t, 'Interpreter', 'latex','FontName','Time New Roman');
...
subplot(224)
save_time = rtcminus(f1,f2) ;
rtcplot( f1,'k',f2,'b',f3,'r--',f4,'g--',save_time,'c:',[0 110 0 500], ...
    'LineWidth',2,...
    'MarkerSize',12,... 
     'MarkerEdgeColor','k',...
      'MarkerFaceColor','r') ;
...
h.FontSize = 8;   
t = title('\boldmath $ Preemption $ \boldmath $ mode $ \boldmath $ Service $ \boldmath $ Curve $ \boldmath $ of $ \boldmath $ AVB_x $\boldmath $ (CBS) $')
set(h, 'Interpreter', 'latex','FontName','Time New Roman');
set(t, 'Interpreter', 'latex','FontName','Time New Roman');
