...
c = categorical({'ES_8 to ES_1','ES_8 to ES_2','ES_8 to ES_3','ES_8 to ES_4','ES_8 to ES_5','ES_8 to ES_6','ES_8 to ES_7'});
 ...
 TT_delay = [300 280 200;310 290 210;320 290 220;290 270 190;312 292 212;305 285 205;318 295 215] ;
...
t = title('\boldmath $ End $ \boldmath $ to $ \boldmath $ End $ \boldmath $ delay $ \boldmath $ of $ \boldmath $ TT $ \boldmath $ for $ \boldmath $ TAS+CBS $')
