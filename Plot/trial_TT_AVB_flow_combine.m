...
TT_new = [1.3 4.264 10.344 7.304 1.560 12.416 4.724 7.464 1.688 11.560 1.776 2.168 1.024 8.624 7.504];
...
AVB_NP = 15+[50.4 45.6 56.0 20.0 32.0 15.2 44.8 9.6 8.8 44.0 20.8 3.2 32.0 3 11.2 149.6 3.2 37.6 92.8 6.4 30.4 6.4 38.4 14.4 39.2 12.8 8.0 99.2 3.2 7.2 54.4 45.6 12.8 13.6]*.1;
AVB_P = 10+[50.4 45.6 56.0 20.0 32.0 15.2 44.8 9.6 8.8 44.0 20.8 3.2 32.0 3 11.2 149.6 3.2 37.6 92.8 6.4 30.4 6.4 38.4 14.4 39.2 12.8 8.0 99.2 3.2 7.2 54.4 45.6 12.8 13.6]*0.1;
t = 1:34;
subplot(212)
plot(t,AVB_TSN,'^',...
     'LineWidth',2,...
...
ylim([0 37])              % Y-Axis Limit
xticks(0:5:35);     % Increment Limit in the X-Axis
yticks(0:9:37);         % Increment Limit in the Y-Axis
